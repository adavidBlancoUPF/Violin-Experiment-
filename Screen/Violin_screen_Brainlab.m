...
%paHandle = PsychPortAudio('Open',[],1,3,fs,2, [], [], [6 7]);
...
if screenNumber == 0
    %%Drawing configuration for Brainlab 
    init_x_arr = 230;
    first_x_arr = 440;
    last_x_arr = 1010;
    y_arr     = 350;
...
c = clock;
fprintf( fid, '[%d/%d/%d T: %d:%d:%d] Experiment Starts: \n',c(3),c(2),c(1),...
    c(4),c(5),c(6));
...
try
    for iTrial=1:nTrials
        ...
        if counter_trials == 5
            ...
            %LOGFILE
            c = clock;
            fprintf( fid, '[%d/%d/%d T: %d:%d:%.2f] %s: \n',c(3),c(2),c(1),...
                c(4),c(5),c(6),Instruction8);
            KbPressWait;
        end
        ...
        c = clock;
        fprintf( fid, '[%d/%d/%d T: %d:%d:%.2f] Porttalk and audio click: \n',c(3),c(2),c(1),...
            c(4),c(5),c(6));
        c = clock;
        fprintf( fid, '[%d/%d/%d T: %d:%d:%.2f] %s: \n',c(3),c(2),c(1),...
            c(4),c(5),c(6),instructions);
